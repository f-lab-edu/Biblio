...
export INPUT_SET="$input_set"
export INPUT_BUCKET="$input_bucket"
export CONTENT_PROFILE="$content_profile"
export VERIFY_RESPONSE="$verify_response"
export RESPONSE_VERIFICATION="$response_verification"
export RETRY_PROFILE="$retry_profile"
export RETRY_SEED="$retry_seed"
export LT_GRACEFUL_STOP="$graceful_stop"
